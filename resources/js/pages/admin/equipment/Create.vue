...
import { index, store, fetchFromUrl } from '@/routes/admin/equipment'
...
<template>
    <AdminLayout title="Neues Equipment" subtitle="Neues Küchenequipment anlegen">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <ImageCropResize
                                ...
                                :existing-image-url="form.image_url"
                                :key="String(!!form.image_url)"
