  ...
  <header class="sticky top-0 z-50 w-full bg-[var(--color-cream)]/95 backdrop-blur-sm border-b border-[var(--color-forest)]/10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 md:h-20">
        <RouterLink to="/" class="font-heading text-xl md:text-2xl font-semibold text-[var(--color-forest)] hover:text-[var(--color-terracotta)] transition-colors" @click="closeMobileMenu">
          Luca Themann
        </RouterLink>
